...
data = get_excel_values(
    ...
    cell_addresses=['C4', 'C6', 'J6', 'D32', 'K10', 'C34', 'J34', 'C37', 'J39', 'K43', 'K45', 'C47', 'K37', 'C41', 'C45', 'C49'], 
...
# Goto Target URL
type_and_enter(text='window.location.href = "https://dataweb.accor.net/dotw-trans/displayHotelAddress!input.action";')
time.sleep(2)
find_logo()
...
input_text(element_id="hotel.telReservation", text=phone)
input_text(element_id="hotel.indFaxReservation", text=phone_country_code)
input_text(element_id="hotel.faxReservation", text=fax)
