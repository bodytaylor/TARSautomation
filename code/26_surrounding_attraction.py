...
def enter_from_df(df, catagory, check_exist=list):
    for index, row in df.iterrows():
        if row['name'] not in check_exist:
            ...
            print(f'{code} {row["name"]} is Added to Data Web!!')
...
# Enter Data for 4 df
enter_from_df(df_comp, catagory='COMP', check_exist=main_attractions)
enter_from_df(df_cong, catagory='CONG', check_exist=main_attractions)
enter_from_df(df_exhi, catagory='EXHI', check_exist=main_attractions)
enter_from_df(df_expo, catagory='EXPO', check_exist=main_attractions)
